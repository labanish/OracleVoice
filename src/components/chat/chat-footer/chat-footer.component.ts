...
export class ChatFooterComponent extends Component {
    ...
    constructor(utils: Utils, private onSend: Function, private sendButtonImgSrc: string, private stopButtonImgSrc: string, private inputPlaceholder: string) {
        super(utils);
		this.element = this._createElement();
		outerScopeInput = this.input;
    ...
    protected _createElement(): HTMLElement {
		...
		this.sendButton = new IconButtonComponent(this.utils, this.onClick.bind(this), this.sendButtonImgSrc);
		this.stopButton = new IconButtonComponent(this.utils, this.onClick.bind(this), this.stopButtonImgSrc);
